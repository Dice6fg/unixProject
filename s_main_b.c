...
int main(void)
{
	...
	{
	case 0:
		execlp("./s_p_b", "s_p_b", "0", "64", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_p_b", "s_p_b", "1", "64", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_p_b", "s_p_b", "2", "64", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_p_b", "s_p_b", "3", "64", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_io_b", "s_io_b", "0", "64", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_io_b", "s_io_b", "1", "64", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_p_b", "s_p_b", "0", "256", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_p_b", "s_p_b", "1", "256", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_p_b", "s_p_b", "2", "256", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_p_b", "s_p_b", "3", "256", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_io_b", "s_io_b", "0", "256", (char*)NULL);
		exit(0);
	default: 
		break;
	}
	...
	{
	case 0:
		execlp("./s_io_b", "s_io_b", "1", "256", (char*)NULL);
		exit(0);
	default: 
		break;
	}
